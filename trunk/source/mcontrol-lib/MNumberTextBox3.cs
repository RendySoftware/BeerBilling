...
namespace mcontrol
{
    public partial class MNumberTextBox3 : TextBox
    {
        public MNumberTextBox3()
        {
            InitializeComponent();
        ...
        public MNumberTextBox3(IContainer container)
        {
            container.Add(this);
        ...
        private bool GetValueFromTextBox(string input, out double value)
        {
        ...
        protected override void OnLeave(EventArgs e)
        {
            ...
            Double value;
            if (GetValueFromTextBox(this.Text, out value))
